...
**App:** iCam365 (Shenzhen Tange) · **Version:** 2.2.58 · **HA:** ≥ 2024.1
...
Geschwindigkeit: 1 Tastendruck = 1 Klick. PTZ-Geschwindigkeit 1–8 skaliert Velocity (Stufe/8) und Klick-Dauer (Stop 0,3 s … 2,1 s nach dem Move). Die Kamera braucht für einen Stop ~1,5 s, kürzere Klicks sind darüber nicht möglich — Diagnose-Aktion `wjg_camera.ptz_test` prüft RelativeMove/Timeout. Während PTZ keine Bewegungs-Aufnahmen.  
...
*Version 2.2.58 · Hersteller: WJG / Tenganda · Modell: XM-3820 · IoT-Klasse: local_polling*
