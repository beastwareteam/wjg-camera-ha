...
from . import (
    ...
    CONF_PATROL_HOME_SECS, CONF_PATROL_REST_STATION, CONF_PATROL_SHUFFLE,
    CONF_PATROL_TILT_HOME_SECS, CONF_PATROL_START,
    ...
    DEFAULT_PATROL_HOME_SECS, DEFAULT_PATROL_REST_STATION, DEFAULT_PATROL_SHUFFLE,
    DEFAULT_PATROL_TILT_HOME_SECS, DEFAULT_PATROL_START,
...
class WJGOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(
        ...
        schema = vol.Schema({
            ...
            vol.Optional(
                CONF_PATROL_SHUFFLE,
                default=bool(_opt(CONF_PATROL_SHUFFLE, DEFAULT_PATROL_SHUFFLE)),
            ): cv.boolean,
            vol.Optional(
            ...
            vol.Optional(
                CONF_PATROL_TILT_HOME_SECS,
                default=_opt(CONF_PATROL_TILT_HOME_SECS, DEFAULT_PATROL_TILT_HOME_SECS),
